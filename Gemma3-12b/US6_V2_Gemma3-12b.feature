...
Scenario: Project manager accesses subordinates
...
Scenario: Project manager restricted from outside structure
    Given the user is logged in as "Project Manager"
    And the user is on the "Employee Management - Profile" page
    When the user attempts to access a profile of an employee outside their reporting structure
...
Scenario: HR staff accesses all profiles
    ...
    When the user navigates to the profile of an employee outside their reporting structure
    Then the text "You do not have permission to access this profile." should be displayed
