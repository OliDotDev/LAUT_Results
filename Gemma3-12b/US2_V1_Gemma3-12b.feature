...
Scenario: Description length validation
    ...
    And the user enters "<shortDescription>" into the "Description" text area
    And the user selects "<system>" from the "Affected Aircraft System" dropdown
    And the user selects "<beginDate>" from the "Begin Date" input field
    And the user enters "<duration>" into the "Total Duration" input field
    And the user clicks the "Submit" button
...
Scenario: Affected Aircraft System required
    ...
    And the user leaves the "Affected Aircraft System" dropdown without selecting an option
    And the user clicks the "Submit" button
...
Scenario: Successful submission
    ...
    And the repair request should be visible in the "Repair Requests" section
