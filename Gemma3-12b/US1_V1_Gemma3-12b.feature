...
Scenario: Manufacturer field required validation shown
    When the user clicks the "Add new aircraft" button
    And the user leaves the "Manufacturer" dropdown empty
    And the user clicks the "Save" button
    Then the validation message "This field is required." should be displayed for the "Manufacturer" input field

Scenario: Manufacturer dropdown populated
    When the user clicks the "Add new aircraft" button
    Then the "Manufacturer" dropdown should contain options for all manufacturers
