...
Scenario: Required fields validation shown
    ...
    Then the validation message "This field is required." should be displayed next to each of these fields: Name, MSN, Manufacturer, Description
...
Scenario: New aircraft added successfully
    ...
    And the user clicks the "Save" button
    Then the modal closes and the user is redirected to the new aircraft detail page

Scenario: Add new aircraft cancelled
    When the user clicks the "Add new aircraft" button
    Then the "Add new aircraft" modal should be displayed
    When the user clicks the "Cancel" button in the "Add new aircraft" modal
    Then the "Add new aircraft" modal should be closed without adding a new aircraft

Scenario: Add new aircraft modal displayed
    When the user clicks the "Add new aircraft" button
    Then the "Add new aircraft" modal should be displayed
    And the modal should contain input fields for "Name", "MSN", a "Manufacturer" dropdown, and a "Description" text area
    And the modal should contain "Save" and "Cancel" buttons
...
Scenario: Add Aircraft - Validation message shown for empty Description field
    When the user clicks the "Add new aircraft" button
    And the user leaves the "Description" field empty
    And the user clicks the "Save" button
    Then the validation message "This field is required." should be displayed next to the "Description" field
...
Scenario: New aircraft added successfully
    When the user clicks the "Add new aircraft" button
    And the user enters "<aircraftName>" into the "Name" input field
    And the user enters "<msnNumber>" into the "MSN" input field
    And the user selects a manufacturer from the "Manufacturer" dropdown
    And the user enters "<description>" into the "Description" text area
    And the user clicks the "Save" button
    Then the user should be redirected to the new aircraft detail page
