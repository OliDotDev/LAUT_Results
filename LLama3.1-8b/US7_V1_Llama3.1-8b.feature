...
Scenario: Booking form displayed with required fields
    ...
    When the user selects a date in the "Start Date" input field that is later than the selected date in the "End Date" input field
    ...
    When the user enters valid dates into both the "Start Date" and "End Date" input fields, selects a valid event type from the dropdown, and clicks the "Submit" button
    Then the booking should be saved and the user should be redirected to the "Event overview" page
    When the user clicks the "Cancel" button
    Then the form should close and the user should be returned to the "Event overview" page
...
Scenario: Booking saved and user redirected on valid submission
    When the user selects an event type from the "Event Type" dropdown
    And the user enters a valid date into the "Start Date" input field
...
Scenario: Form cancelled and user returned on cancel button click
    When the user clicks the "Cancel" button
